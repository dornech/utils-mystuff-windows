...
Welcome to the contributor guide of Personal utilities package for Python - Windows stuff.
...
If you experience bugs or general issues with Personal utilities package for Python - Windows stuff, please have a look
...
You can help improve the documentation of Personal utilities package for Python - Windows stuff by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/utils-mystuff-windows.git
   cd utils-mystuff-windows
   ```
